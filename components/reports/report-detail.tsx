...
import { AnalyticsIcon, ArrowRightIcon } from "@/components/ui/icons";
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 line-clamp-2 max-w-2xl text-3xl font-semibold tracking-tight text-white sm:text-4xl">
